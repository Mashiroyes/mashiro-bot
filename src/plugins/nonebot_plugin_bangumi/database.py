...
headers = {
    ...
    # 把你刚刚拿到的Cookie塞进来
    'Cookie': 'chii_auth=zuFjCEqiqogehvnFSOW1a5nyL38KmFMNJAhzjVMj3CVnF5MLUC4NJRaGsdA0%2BGlKN42mbgkfLCWYnsRQsbZxK1u6g2qoWdlc8Hqg; path=/; domain=.bgm.tv',
    }
...
async def bgm_screenshoot2(content,search_menu,browse_num):   
    ...
    await browse_page.set_extra_http_headers(headers)
